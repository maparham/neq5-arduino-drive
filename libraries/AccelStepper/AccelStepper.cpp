...
{
        long gapSteps =(_speed>4000)? _speed/4:1;
        gapSteps=gapSteps>1 ? --gapSteps : 1;
        if((_n%gapSteps)==0) {
                ...
                else
                {
                        ...
                        _cn = _cn - gapSteps* 2.0 * _cn / ((4.0 * _n) + 1); // Equation 13
                        _cn = max(_cn, _cmin);
                }
                _stepInterval = _cn;
              ...
              //  Serial.print(speed()); Serial.print('\t'); Serial.println(gapSteps);
        }
        _n++;
